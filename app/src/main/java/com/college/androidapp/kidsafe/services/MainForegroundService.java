package com.college.androidapp.kidsafe.services;
...
import com.college.androidapp.kidsafe.activities.BlockedAppActivity;
import com.college.androidapp.kidsafe.activities.ChildSignedInActivity;
import com.college.androidapp.kidsafe.broadcasts.AppInstalledReceiver;
import com.college.androidapp.kidsafe.broadcasts.AppRemovedReceiver;
import com.college.androidapp.kidsafe.broadcasts.PhoneStateReceiver;
import com.college.androidapp.kidsafe.broadcasts.ScreenTimeReceiver;
import com.college.androidapp.kidsafe.broadcasts.SmsReceiver;
import com.college.androidapp.kidsafe.models.App;
import com.college.androidapp.kidsafe.models.Child;
import com.college.androidapp.kidsafe.models.Contact;
import com.college.androidapp.kidsafe.models.ScreenLock;
...
import static com.college.androidapp.kidsafe.NotificationChannelCreator.CHANNEL_ID;
...
public class MainForegroundService extends Service {
	...
	public static final String BLOCKED_APP_NAME_EXTRA = "com.college.androidapp.kidsafe.services.BLOCKED_APP_NAME_EXTRA";
	...
	private void setFence(DataSnapshot dataSnapshot) {
		final com.college.androidapp.kidsafe.models.Location childLocation = dataSnapshot.getValue(com.college.androidapp.kidsafe.models.Location.class);
	...
	private String getLollipopForegroundAppPackageName() {
		...
		try {
			...
			for (UsageStats stats : foregroundApps) {
                /*if (i == 0 && !"com.college.androidapp.kidsafe".equals(stats.getPackageName())) {
